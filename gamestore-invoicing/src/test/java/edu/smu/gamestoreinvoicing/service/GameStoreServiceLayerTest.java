...
import edu.smu.gamestoreinvoicing.model.*;
import edu.smu.gamestoreinvoicing.repository.InvoiceRepository;
...
import edu.smu.gamestoreinvoicing.util.feign.CatalogClient;
import edu.smu.gamestoreinvoicing.viewModel.InvoiceViewModel;
...
public class GameStoreServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new GameStoreServiceLayer(catalogClient, invoiceRepository, taxRepository, processingFeeRepository);
    }
