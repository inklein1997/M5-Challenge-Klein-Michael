...
import edu.smu.gamestorecatalog.repository.*;
import edu.smu.gamestorecatalog.model.*;
import edu.smu.gamestorecatalog.viewModel.ConsoleViewModel;
import edu.smu.gamestorecatalog.viewModel.GameViewModel;
//import edu.smu.gamestorecatalog.viewModel.InvoiceViewModel;
...
public class GameStoreServiceLayer {
    ...
    public TShirtViewModel createTShirt(TShirtViewModel tShirtViewModel) {
        ...
        if (tShirtViewModel==null) {
            throw new IllegalArgumentException("No TShirt is passed! TShirt object is null!");
        };
